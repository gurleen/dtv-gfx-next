...
Play = namedtuple('Play', ('number', 'actionId', 'sequence', 'vh', 'team', 'clock', 'action', 'text', 'vscore', 'hscore'), defaults=[None] * 10)
...
def parse(raw_xml: str):
    ...
    officals = [x.attrib["name"] for x in root.iter("official")]
